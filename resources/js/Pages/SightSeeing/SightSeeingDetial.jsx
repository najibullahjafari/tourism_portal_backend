...
const SightSeeingDetial = () => {
    const { data, news } = usePage().props;
    return (
        <div>
            <div class="bg-gray-100 flex justify-center items-center py-20">
                <div class="bg-white shadow-lg rounded-lg mx-auto sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/3 sm:mx-4px md:mx-5">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600 px-5">
                            {data[0].description}. It is located in{" "}
                            {data[0].province} province. {data[0].name} is
                            opened at {data[0].open_time} and is closed at{" "}
                            {data[0].close_time}.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-row items-center justify-center">
                        <Button
                            ...
                            onClick={() => {
                                router.get(
                                    `/like/${data[0].id}?type=sight_seeing&page=sight_seeingDetial`
                                );
                            }}
                        >
                        ...
                        <Button
                            ...
                            onClick={() => router.get("/")} // /sightSeeing/view
                        ></Button>
                    </div>
                </div>
            </div>
                ...
                >
                    <div class="bg-white shadow-lg rounded-lg mx-auto sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/3 sm:mx-4px md:mx-5">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <p class="text-gray-600 px-5">{item.description}</p>
                        </div>
                        <div className="flex flex-row items-center justify-center">
                            <Button
                                className="mx-3 my-3 text-blue-600 hover:text-blue-700 bg-white font-bold py-1 px-2 rounded border-white hover:shadow-lg hover:border-blue-500 "
                                ...
                                onClick={() => {
                                    router.get(
                                        `/like/${item.id}?type=sightSeeingNews&page=sight_seeingDetial`
                                    );
                                }}
                            >
                                <span className="ml-2">{item.liked}</span>
                            </Button>
                            <Button
                                className="mx-3 my-3 text-blue-600 hover:text-blue-700 bg-white font-bold py-1 px-2 rounded border-white hover:shadow-lg hover:border-blue-500 "
                                icon="pi pi-arrow-left"
...
export default SightSeeingDetial;
