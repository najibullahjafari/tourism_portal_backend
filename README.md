...
Tourism Portal is a system that allows users to book for tourist sites and also allows the admin to manage the tourist sites and bookings.
An admin can add, edit, delete tourist sites and also view bookings made by users.
A tourist can view tourist sites, book for a tourist site and also view bookings made by him/her.
...
Tourism Portal aims to provide a user-friendly interface for managing tourist sites and bookings. The project leverages Laravel, Inertia.js, React, and PrimeReact to deliver a seamless and interactive experience for both users and administrators.

## Getting Started

To get started with Tourism Portal System first clone the [Tourism Portal](https://github.com/boadusamuel/laravel-inertia-react) repository.

**Clone Repository:**

```bash
git clone https://github.com/najibullahjafari/tourism_portal_backend
```
